    ...
    <form id="form1" runat="server">
        <div>
           ...
           <%--             <asp:ButtonField ButtonType="Image" CommandName="Select" ImageUrl="~/ikon/editikon.png" Text="EDİT"/>--%>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <%--<a href="#" onclick='Edit("<%# Eval("New_TransactionId") %>")'>
                                    <img src="/ikon/editikon.png" height="40" width="40" />
                                </a>--%>
                                
                                <asp:ImageButton ID="btn_edit" runat="server" ImageUrl="~/ikon/editikon.png" OnClientClick="Edit(5); return false"  Height="40" Width="40" />
                            </ItemTemplate>
                        </asp:TemplateField>
